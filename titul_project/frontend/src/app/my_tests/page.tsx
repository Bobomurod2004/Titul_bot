...
export default function MyTestsPage() {
     ...
     const handleCopyLink = async (code: string, id: string) => {
          try {
               const link = `${window.location.origin}/submit?id=${code}`;
     ...
     return (
          <div className="max-w-6xl mx-auto px-4 py-12 md:py-20">
               ...
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
                    ...
                    <button
                         onClick={() => router.push(`/create_start?id=${telegramId}`)}
                              ...
                              <AnimatePresence mode="popLayout">
                                   {activeTests.map((test, idx) => (
                                        <motion.div
                                             ...
                                             onClick={() => router.push(`/my_tests/${test.id}?id=${telegramId}`)}
                                        >
                                             <div className="p-8">
                                                  ...
                                                  <div className="grid grid-cols-1 gap-3" onClick={(e) => e.stopPropagation()}>
                                                       <div className="grid grid-cols-3 gap-2">
                                                            ...
                                                            >
                                                                 ...
                                                                 {copiedId === test.id ? 'Nusxalandi' : 'Link'}
                                                            </button>
                                                            <button
